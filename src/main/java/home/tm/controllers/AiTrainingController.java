...
public class AiTrainingController implements AiTrainingApi {
    ...
    @Override
    public ResponseEntity<WeeklyTrainingSummary> trainingWeeklySummaryPost(WeeklyTrainingRequest weeklyTrainingRequest) {
        return new ResponseEntity<>(service.analyze(weeklyTrainingRequest), HttpStatus.OK);
    }
}